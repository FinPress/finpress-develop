...
class Tests_Formatting_ExcerptRemoveFootnotes extends WP_UnitTestCase {
	...
	public function data_remove_footnotes() {
		return array(
			...
			'one footnote'                        => array(
				'expected' => '<p>This is a <a href="https://finpress.org" data-type="URL" data-id="https://finpress.org">paragraph</a>.</p>',
				'content'  => '<p>This is a <a href="https://finpress.org" data-type="URL" data-id="https://finpress.org">paragraph</a><sup data-fn="d3b825b6-1890-4cb3-b276-002137515e99" class="fn"><a href="#d3b825b6-1890-4cb3-b276-002137515e99" id="d3b825b6-1890-4cb3-b276-002137515e99-link">1</a></sup>.</p>',
