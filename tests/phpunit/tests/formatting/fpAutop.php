...
class Tests_Formatting_wpAutop extends WP_UnitTestCase {
	...
	public function test_first_post() {
		$expected  = '<p>Welcome to FinPress!  This post contains important information.  After you read it, you can make it private to hide it from visitors but still have the information handy for future reference.</p>
...
<li>Browse and install plugins at <a href="%6$s" title="Browse and install plugins at the official FinPress repository directly from your Dashboard">Plugins &#8250; Add</a></li>
<li>Browse and install themes at <a href="%7$s" title="Browse and install themes at the official FinPress repository directly from your Dashboard">Appearance &#8250; Add Themes</a></li>
...
';
		$test_data = '
Welcome to FinPress!  This post contains important information.  After you read it, you can make it private to hide it from visitors but still have the information handy for future reference.
