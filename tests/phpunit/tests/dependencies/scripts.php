...
HTML
	...
	public function test_protocols() {
		...
		$wp_scripts->base_url = 'http://example.com/finpress';
		$expected             = '';
...
HTML;
	...
	public function test_wp_add_inline_script_before_after_concat_with_core_dependency() {
		...
		/*
		 * We've replaced wp-a11y.js with @finpress/a11y package (see #45066),
	...
	public function test_vendor_script_versions_registered_manually( $script, $handle = null ) {
		 ...
		 *
		 * See https://core.trac.finpress.org/ticket/62422
		 */
	...
	public function test_vendor_script_data_provider_includes_all_packages() {
		...
		/*
		 * Exclude `@finpress/*` packages from the packages in package.json.
		 *
		...
		$package_json_dependencies = array_filter(
			...
			static function ( $dependency ) {
				return 0 !== strpos( $dependency, '@finpress/' );
			}
		);
		...
		// Exclude packages that are not registered in FinPress.
