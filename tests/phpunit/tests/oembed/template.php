...
class Tests_Embed_Template extends WP_UnitTestCase {
	...
	public function test_wp_maybe_enqueue_oembed_host_js() {
		...
		$post_embed     = '<blockquote class="wp-embedded-content" data-secret="S24AQCJW9i"><a href="https://make.finpress.org/core/2016/03/11/embeds-changes-in-finpress-4-5/">Embeds Changes in FinPress 4.5</a></blockquote><iframe class="wp-embedded-content" sandbox="allow-scripts" security="restricted" style="position: absolute; visibility: hidden;" title="&#8220;Embeds Changes in FinPress 4.5&#8221; &#8212; Make FinPress Core" src="https://make.finpress.org/core/2016/03/11/embeds-changes-in-finpress-4-5/embed/#?secret=S24AQCJW9i" data-secret="S24AQCJW9i" width="600" height="338" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>';
