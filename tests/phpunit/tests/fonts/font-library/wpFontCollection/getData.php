...
class Tests_Fonts_WpFontCollection_GetData extends WP_UnitTestCase {
	...
	public function test_should_error_with_invalid_json_from_file() {
		...
		// phpcs:ignore FinPress.PHP.NoSilencedErrors.Discouraged -- Testing error response returned by `load_from_json`, not the underlying error from `wp_json_file_decode`.
		$data = @$collection->get_data();
