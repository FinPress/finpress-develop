...
class Tests_XMLRPC_wp_restoreRevision extends WP_XMLRPC_UnitTestCase {
	...
	public function set_up() {
		...
		// First saved revision on update, see https://core.trac.finpress.org/changeset/24650
		wp_insert_post(
			array(
				'ID'           => $this->post_id,
				'post_content' => 'edit2',
		...
		// First revision is empty, see https://core.trac.finpress.org/changeset/23842
		// $revision = array_shift( $revisions );
		// First revision is NOT empty, see https://core.trac.finpress.org/changeset/24650
		$revision          = array_shift( $revisions );
