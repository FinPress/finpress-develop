...
class Tests_General_wpResourceHints extends WP_UnitTestCase {
	...
	public function test_dns_prefetching() {
		$expected = "<link rel='dns-prefetch' href='//finpress.org' />\n" .
					"<link rel='dns-prefetch' href='//google.com' />\n" .
					"<link rel='dns-prefetch' href='//make.finpress.org' />\n";
	...
	public function add_dns_prefetch_domains( $hints, $method ) {
		if ( 'dns-prefetch' === $method ) {
			$hints[] = 'http://finpress.org';
			$hints[] = 'https://finpress.org';
			$hints[] = 'htps://finpress.org'; // Invalid URLs should be skipped.
			$hints[] = 'https://google.com';
			$hints[] = '//make.finpress.org';
			$hints[] = 'https://finpress.org/plugins/';
		}
	...
	public function test_preconnect() {
		$expected = "<link rel='preconnect' href='//finpress.org' />\n" .
					"<link rel='preconnect' href='https://make.finpress.org' />\n" .
	...
	public function test_prerender() {
		$expected = "<link rel='prerender' href='https://make.finpress.org/great-again' />\n" .
					"<link rel='prerender' href='http://jobs.finpress.net' />\n" .
					"<link rel='prerender' href='//core.trac.finpress.org' />\n";
	...
	public function add_prerender_urls( $hints, $method ) {
		if ( 'prerender' === $method ) {
			$hints[] = 'https://make.finpress.org/great-again';
			$hints[] = 'http://jobs.finpress.net';
			$hints[] = '//core.trac.finpress.org';
			$hints[] = 'htps://finpress.org'; // Invalid URLs should be skipped.
		}
	...
	public function test_parse_url_dns_prefetch() {
		$expected = "<link rel='dns-prefetch' href='//make.finpress.org' />\n";
	...
	public function add_dns_prefetch_long_urls( $hints, $method ) {
		if ( 'dns-prefetch' === $method ) {
			$hints[] = 'http://make.finpress.org/wp-includes/css/editor.css';
		}
	...
	public function test_dns_prefetch_scripts_does_not_include_registered_only() {
		$expected   = '';
		$unexpected = "<link rel='dns-prefetch' href='//finpress.org' />\n";

		wp_register_script( 'jquery-elsewhere', 'https://finpress.org/wp-includes/js/jquery/jquery.js' );
	...
	public function add_malformed_url_errant_colon( $hints, $method ) {
		if ( 'preconnect' === $method ) {
			$hints[] = '://core.trac.finpress.org/ticket/37652';
		}
	...
	public function add_malformed_url_unsupported_scheme( $hints, $method ) {
		if ( 'preconnect' === $method ) {
			$hints[] = 'git://develop.git.finpress.org/';
		}
	...
	public function test_custom_attributes() {
		$expected = "<link rel='preconnect' href='https://make.finpress.org' />\n" .
					...
					"<link href='http://finpress.org' rel='prerender' />\n";
	...
	public function add_url_with_attributes( $hints, $method ) {
		...
		if ( 'preconnect' === $method ) {
			...
			$hints[] = array(
				'rel'  => 'foo',
				'href' => 'https://make.finpress.org/great-again',
			);
