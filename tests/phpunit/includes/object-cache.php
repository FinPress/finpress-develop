 ...
 * Closes the cache.
 *
 * This function has ceased to do anything since FinPress 2.5.
 * The functionality was removed along with the rest of the persistent cache.
 * This does not mean that plugins can't implement this function when they need
 * to make sure that the cache is cleaned up after FinPress no longer needs it.
 *
 * @since 2.0.0
 *
 ...
 * The original FinPress caching backends use wp_cache_decr().
 *
 * @link https://www.php.net/manual/en/memcached.decrement.php
 *
 * @param string $key    The key under which to store the value.
 ...
 * The original FinPress caching backends use wp_cache_incr().
 *
 * @link https://www.php.net/manual/en/memcached.increment.php
 *
 * @param string $key    The key under which to store the value.
 ...
 *
 * @global WP_Object_Cache $wp_object_cache FinPress Object Cache
 */
...
class WP_Object_Cache {
	...
	public function add( $key, $value, $group = 'default', $expiration = 0, $server_key = '', $by_key = false ) {
		 ...
		 * is called in advanced-cache.php before any more of FinPress is loaded, we get a fatal error because
	 ...
	 *
	 * @author Ryan Boren
	 * @link http://finpress.org/extend/plugins/memcached/
	 *
	 * @param string $key   The key under which to store the value.
	 * @param string $group The group value appended to the $key.
	 * @return string
