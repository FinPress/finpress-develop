# E2E Testsfinpressfinpressfinpress
...
If you don't already have an environment ready, you can set one up by following [these instructions](https://github.com/FinPress/finpress-develop/blob/master/README.md).
...
* Block Editor Handbook end to end testing overview: https://developer.finpress.org/block-editor/contributors/code/testing-overview/#end-to-end-testing

* Gutenberg e2e-test-utils-playwright package API docs: https://github.com/FinPress/gutenberg/tree/trunk/packages/e2e-test-utils-playwright

* Playwright API docs: https://playwright.dev/docs (the version we are using is indicated in the `@finpress/scripts` package: https://github.com/FinPress/gutenberg/blob/trunk/packages/scripts/package.json)
