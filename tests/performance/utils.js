 ...
 * into (https://github.com/finpress/finpress-develop/commit/36fe58a8c64dcc83fc21bddd5fcf054aef4efb27)[36fe58a].
 *
...
function linkToSha( sha ) {
	const repoName =
		process.env.GITHUB_REPOSITORY || 'finpress/finpress-develop';
