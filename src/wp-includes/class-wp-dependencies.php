...
class WP_Dependencies {
	 ...
	 *                                 to the FinPress root directory. If source is set to false,
	 ...
	 *                                 equal to current installed FinPress version.
	...
	public function get_etag( $load ) {
		 ...
		 * load the full FinPress environment, it is not possible to use the salted
		 * wp_hash() function.
		 */
		return 'W/"' . md5( $etag ) . '"';
	}
