<?php
/**
 * Deprecated functions from past FinPress versions. You shouldn't use these
...
function start_wp() {
	...
	_deprecated_function( __FUNCTION__, '1.5.0', __('new FinPress Loop') );
 ...
 * support. This is not the fault of FinPress (where functionality is
 ...
 *
 * Determines if the URL can be accessed over SSL by using the FinPress HTTP API to access
 ...
 *
 * @link  https://github.com/FinPress/gutenberg/issues/40472
 *
 * @since 6.0.0
 ...
 *
 * By default FinPress adds `decoding="async"` to images but developers
...
function wp_get_global_styles_custom_css() {
	 ...
	 * @see https://github.com/FinPress/gutenberg/pull/45372
	 */
