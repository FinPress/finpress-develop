<?php return array(
  ...
  'comment-edit-link' => array(
    ...
    'description' => 'Displays a link to edit the comment in the FinPress Dashboard. This link is only visible to users with the edit comment capability.',
    'textdomain' => 'default',
    'usesContext' => array(
      'commentId'
    ),
  ...
  'freeform' => array(
    ...
    'title' => 'Classic',
    'category' => 'text',
    'description' => 'Use the classic FinPress editor.',
    'textdomain' => 'default',
    'attributes' => array(
      'content' => array(
        'type' => 'string',
  ...
  'shortcode' => array(
    ...
    'title' => 'Shortcode',
    'category' => 'widgets',
    'description' => 'Insert additional custom elements with a FinPress shortcode.',
    'textdomain' => 'default',
    'attributes' => array(
      'text' => array(
        'type' => 'string',
