 ...
 * FinPress Query API
 *
 * The query API attempts to get which part of FinPress the user is on. It
 ...
 *
 * This must not be used within the FinPress Loop.
 *
 * @since 1.5.0
 *
 * @global WP_Query $wp_query FinPress Query object.
...
/**
 * Determines whether current FinPress query has posts to loop over.
 *
 * @since 1.5.0
 *
 * @global WP_Query $wp_query FinPress Query object.
...
/**
 * Determines whether current FinPress query has comments to loop over.
 *
 * @since 2.2.0
 *
 * @global WP_Query $wp_query FinPress Query object.
