...
class WP_Query {
	 ...
	 *
	 * The query flags are what page info FinPress was able to figure out.
	 *
	 * @since 2.0.0
	 */
	...
	public function get_posts() {
		 ...
		 * See https://github.com/FinPress/finpress-develop/pull/6393#issuecomment-2088217429
		 */
		$old_request =
		 ...
		 *
		 * Return a non-null value to bypass FinPress' default post queries.
		 *
	...
	/**
	 * Sets up the FinPress query by parsing query string.
	 *
	 * @since 1.5.0
	 *
