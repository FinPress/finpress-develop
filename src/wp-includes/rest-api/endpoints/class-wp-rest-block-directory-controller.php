...
class WP_REST_Block_Directory_Controller extends WP_REST_Controller {
	 ...
	 * @since 5.5.0
	 *
	 * @param array $plugin The plugin data from FinPress.org.
	 * @return array
	 */
	 ...
	 * @since 5.5.0
	 *
	 * @param string $slug The FinPress.org directory slug for a plugin.
	...
	public function get_item_schema() {
		...
		$this->schema = array(
			...
			'properties' => array(
				...
				'author'              => array(
					'description' => __( 'The FinPress.org username of the block author.' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
				),
				'icon'                => array(
