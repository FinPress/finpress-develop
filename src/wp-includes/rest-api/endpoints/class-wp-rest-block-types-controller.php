...
class WP_REST_Block_Types_Controller extends WP_REST_Controller {
	...
	public function prepare_item_for_response( $item, $request ) {
		...
		// Fields deprecated in FinPress 6.1, but left in the schema for backwards compatibility.
	...
	public function get_item_schema() {
		...
		// Properties deprecated in FinPress 6.1, but left in the schema for backwards compatibility.
