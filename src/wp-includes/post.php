 ...
 * context of the inner workings of FinPress, pages, posts, and attachments
 ...
 * criteria of posts to retrieve. The 'post_type' can be anything, but FinPress
...
/**
 * Retrieves all of the FinPress supported post statuses.
 *
...
/**
 * Retrieves all of the FinPress support page statuses.
 *
...
function wp_untrash_post( $post_id = 0 ) {
	 ...
	 *
	 * Prior to FinPress 5.6.0, restored posts were always assigned their original status.
	 *
	 * @since 5.6.0
	 *
 ...
 *
 * @link https://github.com/FinPress/gutenberg/pull/51144
 */
