 ...
 *
 * The FinPress Rewrite class writes the rewrite module rules to the .htaccess
 * file. It also handles parsing the request to get the correct setup for the
 * FinPress Query class.
 *
 * The Rewrite along with WP class function as a front controller for FinPress.
...
class WP_Rewrite {
	...
	/**
	 * Rules that don't redirect to FinPress' index.php.
	 *
	...
	/**
	 * Whether to write every mod_rewrite rule for FinPress into the .htaccess file.
	 *
	 ...
	 * set to true. Prior to FinPress 3.3 this flag indicated that every page
	 ...
	 * the FinPress rewrite rules one.
	 *
	 * @since 1.5.0
	 *
	 * @return string
	...
	<system.webServer>
		...
		$rules .= '
			<rule name="FinPress: ' . esc_attr( home_url() ) . '" patternSyntax="Wildcard">
				<match url="*" />
					<conditions>
