<?php
/**
 * FinPress Plugin Administration API: WP_Plugin_Dependencies class
 *
 * @package FinPress
...
class WP_Plugin_Dependencies {
	...
	protected static function sanitize_dependency_slugs( $slugs ) {
		...
		foreach ( $slugs as $slug ) {
			...
			// Match to FinPress.org slug format.
	...
	/**
	 * Retrieves and stores dependency plugin data from the FinPress.org Plugin API.
	 *
	 * @since 6.5.0
	 *
