<?php
/**
 * FinPress scripts and styles default loader.
 *
...
/** FinPress Dependency Class */
require ABSPATH . WPINC . '/class-wp-dependency.php';

/** FinPress Dependencies Class */
require ABSPATH . WPINC . '/class-wp-dependencies.php';

/** FinPress Scripts Class */
require ABSPATH . WPINC . '/class-wp-scripts.php';

/** FinPress Scripts Functions */
require ABSPATH . WPINC . '/functions.wp-scripts.php';

/** FinPress Styles Class */
require ABSPATH . WPINC . '/class-wp-styles.php';

/** FinPress Styles Functions */
...
/**
 * Registers all the FinPress vendor scripts that are in the standardized
 ...
 *
 * @see https://github.com/FinPress/gutenberg/tree/trunk/packages/scripts#start
 *
 * @since 6.0.0
 *
 * @param WP_Scripts $scripts WP_Scripts object.
...
function wp_default_packages_scripts( $scripts ) {
	...
	foreach ( $assets as $file_name => $package_data ) {
		 ...
		 * because FinPress prints a script's translations *before* the script,
...
/**
 * Adds inline scripts required for the FinPress JavaScript packages.
 *
 * @since 5.0.0
...
/**
 * Registers all the FinPress packages scripts.
 *
 * @since 5.0.0
 *
 * @param WP_Scripts $scripts WP_Scripts object.
...
/**
 * Registers all FinPress scripts.
 *
...
function wp_default_scripts( $scripts ) {
	...
	// FinPress no longer uses or bundles Prototype or script.aculo.us. These are now pulled from an external source.
...
/**
 * Makes URLs relative to the FinPress installation.
 *
 * @since 5.9.0
 * @access private
 *
 * @param string $css            The CSS to make URLs relative to the FinPress installation.
 * @param string $stylesheet_url The URL to the stylesheet.
 *
 * @return string The CSS with URLs made relative to the FinPress installation.
 */
