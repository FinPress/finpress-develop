...
/**
 * Registers a new field on an existing FinPress object type.
 *
 * @since 4.7.0
 *
...
function rest_handle_deprecated_function( $function_name, $replacement, $version ) {
	...
	if ( ! empty( $replacement ) ) {
		/* translators: 1: Function name, 2: FinPress version number, 3: New function name. */
		$string = sprintf( __( '%1$s (since %2$s; use %3$s instead)' ), $function_name, $version, $replacement );
	} else {
		/* translators: 1: Function name, 2: FinPress version number. */
...
function rest_handle_deprecated_argument( $function_name, $message, $version ) {
	...
	if ( $message ) {
		/* translators: 1: Function name, 2: FinPress version number, 3: Error message. */
 ...
 * @param string|null $version       The version of FinPress where the message was added.
 */
function rest_handle_doing_it_wrong( $function_name, $message, $version ) {
	...
	if ( $version ) {
		/* translators: Developer debugging message. 1: PHP function name, 2: FinPress version number, 3: Explanatory message. */
 ...
 *
 * FinPress' built-in cookie authentication is always active
