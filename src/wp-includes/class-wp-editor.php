<?php
/**
 * Facilitates adding of the FinPress editor as used on the Write and Edit screens.
 *
 * @package FinPress
 * @since 3.3.0
 *
...
final class _WP_Editors {
		...
		if ( self::$this_tinymce ) {
			...
			if ( empty( self::$first_init ) ) {
				...
				if ( $set['teeny'] ) {
					 ...
					 * in FinPress should be added to the TinyMCE instance.
					 *
					 * @since 3.3.0
					 * @since 5.3.0 The `$editor_id` parameter was added.
					 *
	 ...
	 * sure that FinPress uses the uncompressed TinyMCE file if a theme is defined.
