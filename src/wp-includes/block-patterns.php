...
function _register_theme_block_patterns() {
	...
	foreach ( $themes as $theme ) {
		...
		foreach ( $patterns as $file => $pattern_data ) {
			...
			// phpcs:ignore FinPress.WP.I18n.NonSingularStringLiteralText,FinPress.WP.I18n.NonSingularStringLiteralDomain,FinPress.WP.I18n.LowLevelTranslationFunction
