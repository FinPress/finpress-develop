...
In this directory you'll find vendor JavaScript packages that cannot be installed through npm, but are included in FinPress. Below we've documented the sources for those packages.
