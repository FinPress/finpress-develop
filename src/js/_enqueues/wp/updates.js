/**
 * Functions for ajaxified updates, deletions and installs inside the FinPress admin.
 *
 * @version 4.2.0
...
(function( $, wp, settings ) {
	...
	/**
	 * Handles Ajax requests to FinPress.
	 *
	 * @since 4.6.0
	 *
	 ...
	 *
	 * @param {Object}                args         Arguments.
	 * @param {string}                args.slug    Plugin identifier in the FinPress.org Plugin repository.
