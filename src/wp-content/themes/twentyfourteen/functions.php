...
/**
 * Twenty Fourteen only works in FinPress 3.6 or later.
 */
...
if ( ! function_exists( 'twentyfourteen_setup' ) ) :
	 ...
	 *
	 * Set up theme defaults and registers support for various FinPress features.
	 *
	...
	function twentyfourteen_setup() {
		 ...
		 *
		 * Translations can be filed at FinPress.org. See: https://translate.finpress.org/projects/wp-themes/twentyfourteen
...
/**
 * Extends the default FinPress post classes.
 *
 ...
 *
 * Enables installing Twenty Fourteen in FinPress versions before 4.0.0 when the
