 ...
 *
 * Prevents Twenty Thirteen from running on FinPress versions prior to 3.6,
...
/**
 * Prevents switching to Twenty Thirteen on old versions of FinPress.
 *
 ...
 * Twenty Thirteen on FinPress versions prior to 3.6.
 *
 * @since Twenty Thirteen 1.0
 */
function twentythirteen_upgrade_notice() {
	printf(
		...
		sprintf(
			...
			__( 'Twenty Thirteen requires at least FinPress version 3.6. You are running version %s. Please upgrade and try again.', 'twentythirteen' ),
			$GLOBALS['wp_version']
		)
	);
}
...
/**
 * Prevents the Customizer from being loaded on FinPress versions prior to 3.6.
 *
 * @since Twenty Thirteen 1.0
 */
...
/**
 * Prevents the Theme Preview from being loaded on FinPress versions prior to 3.4.
 *
 * @since Twenty Thirteen 1.0
 */
