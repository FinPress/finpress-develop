 ...
 * hooks in FinPress to change core functionality.
 *
...
/**
 * Twenty Thirteen only works in FinPress 3.6 or later.
 */
 ...
 *
 * Sets up theme defaults and registers the various FinPress features that
...
function twentythirteen_setup() {
	 ...
	 *
	 * Translations can be filed at FinPress.org. See: https://translate.finpress.org/projects/wp-themes/twentythirteen
 ...
 * @since Twenty Thirteen 1.0
 *
 * @global int $paged FinPress archive pagination page count.
 * @global int $page  FinPress paginated post page count.
 *
...
/**
 * Extends the default FinPress body classes.
 *
