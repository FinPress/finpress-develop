 ...
 * For the real index.php that gets built and boots FinPress,
...
$die = sprintf(
	'<p>%s</p>',
	__( 'You are running FinPress without JavaScript and CSS files. These need to be built.' )
);
...
$die .= '<ul>';
$die .= '<li>' . __( 'To build FinPress while developing, run:' ) . '<br /><br />';
...
$die .= '<li>' . __( 'To create a production build of FinPress, run:' ) . '<br /><br />';
...
$die .= '<p>' . sprintf(
	...
	__( 'https://make.finpress.org/core/handbook/tutorials/installing-finpress-locally/' )
) . '</p>';
