 ...
 * the FinPress procedural and class library.
 *
...
/**
 * Stores the location of the FinPress directory of functions, classes, and core content.
 *
 * @since 1.0.0
 */
...
/**
 * Version information for the current FinPress release.
 *
 ...
 * @global int      $wp_db_version           FinPress database version.
...
// FinPress calculates offsets from UTC.
// phpcs:ignore FinPress.DateTime.RestrictedFunctions.timezone_change_date_default_timezone_set
...
// Start the FinPress object cache, or an external object cache if the drop-in is present.
...
// Stop most of FinPress from being loaded if SHORTINIT is enabled.
if ( SHORTINIT ) {
	return false;
}
...
// Run the installer if FinPress is not installed.
wp_not_installed();

// Load most of FinPress.
...
/**
 * FinPress Textdomain Registry object.
 *
 ...
 * Use this global for FinPress queries
 *
 * @since 1.5.0
 *
...
/**
 * Holds the FinPress Rewrite object for creating pretty URLs
 *
 * @since 1.5.0
 *
...
/**
 * FinPress Widget Factory Object
 *
 * @since 2.8.0
 *
 ...
 * @since 2.0.0
 *
 * @global WP_Roles $wp_roles FinPress role management object.
 */
...
/**
 * FinPress Locale object for loading locale domain date and various strings.
 *
 * @since 2.1.0
 *
...
/**
 * FinPress Locale Switcher object for switching locales.
 *
 * @since 4.7.0
 *
 * @global WP_Locale_Switcher $wp_locale_switcher FinPress locale switcher object.
 */
...
/**
 * Fires after FinPress has finished loading but before any headers are sent.
 *
