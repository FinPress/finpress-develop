...
?>
<form role="search" <?php echo $twentytwenty_aria_label; // phpcs:ignore FinPress.Security.EscapeOutput.OutputNotEscaped -- Escaped above. ?> method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label for="<?php echo esc_attr( $twentytwenty_unique_id ); ?>">
		<span class="screen-reader-text">
			<?php
			/* translators: Hidden accessibility text. */
			_e( 'Search for:', 'twentytwenty' ); // phpcs:ignore: FinPress.Security.EscapeOutput.UnsafePrintingFunction -- core trusts translations
			?>
		</span>
