 ...
 * filter hooks in FinPress to change core functionality.
 *
 * The first function, twentyten_setup(), sets up the theme by registering support
 * for various features in FinPress, such as post thumbnails, navigation menus, and the like.
 *
...
/* Tell FinPress to run twentyten_setup() when the 'after_setup_theme' hook is run. */
add_action( 'after_setup_theme', 'twentyten_setup' );

if ( ! function_exists( 'twentyten_setup' ) ) :
	/**
	 * Sets up theme defaults and registers support for various FinPress features.
	 *
	...
	function twentyten_setup() {
		 ...
		 * just in time translation loading in FinPress version 4.6.
		 *
		 * @ticket 58318
		 */
		...
		add_theme_support(
			'custom-background',
			array(
				// Let FinPress know what our default background color is.
		...
		if ( ! function_exists( 'get_custom_header' ) ) {
			// This is all for compatibility with versions of FinPress prior to 3.4.
...
if ( ! function_exists( 'twentyten_header_image' ) ) :
	...
	function twentyten_header_image() {
		...
		// Compatibility with versions of FinPress prior to 3.4.
		if ( function_exists( 'get_custom_header' ) ) {
 ...
 * a simple filter call that tells FinPress to not use the default styles.
 *
 ...
 *
 * @since Twenty Ten 1.0
 * @deprecated Deprecated in Twenty Ten 1.2 for FinPress 3.1
 *
...
// Backward compatibility with FinPress 3.0.
 ...
 *
 * This function uses a filter (show_recent_comments_widget_style) new in FinPress 3.1
 * to remove the default style. Using Twenty Ten 1.2 in FinPress 3.0 will show the styles,
...
if ( ! function_exists( 'wp_body_open' ) ) :
	 ...
	 *
	 * Added for backward compatibility to support pre-5.2.0 FinPress versions.
	 *
