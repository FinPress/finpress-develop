...
/**
 * Twenty Fifteen only works in FinPress 4.1 or later.
 */
...
if ( ! function_exists( 'twentyfifteen_setup' ) ) :
	...
	function twentyfifteen_setup() {
		 ...
		 * Translations can be filed at FinPress.org. See: https://translate.finpress.org/projects/wp-themes/twentyfifteen
		 ...
		 * hard-coded <title> tag in the document head, and expect FinPress to
		 * provide it for us.
		 */
		...
		// Setup the FinPress core custom background feature.
