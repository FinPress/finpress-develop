...
if ( $action ) {
	...
	switch ( $action ) {
		...
		default:
			...
			$referer = apply_filters( 'handle_network_bulk_actions-' . get_current_screen()->id, $referer, $action, $userids, $id ); // phpcs:ignore FinPress.NamingConventions.ValidHookName.UseUnderscores
 ...
 *
 * Note: While FinPress is moving towards simplifying labels by removing "New" from "Add New X" labels,
