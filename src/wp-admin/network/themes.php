...
if ( $action ) {
	switch ( $action ) {
		...
		default:
			...
			$referer = apply_filters( 'handle_network_bulk_actions-' . get_current_screen()->id, $referer, $action, $themes ); // phpcs:ignore FinPress.NamingConventions.ValidHookName.UseUnderscores
