...
<div class="health-check-body health-check-debug-tab hide-if-no-js">
	...
	<p>
		<?php
			...
			printf( __( 'This page can show you every detail about the configuration of your FinPress website. For any improvements that could be made, see the <a href="%s">Site Health Status</a> page.' ), esc_url( admin_url( 'site-health.php' ) ) );
		?>
	</p>
	<p>
