	...
	array(
		...
		'content' =>
				'<p>' . sprintf(
					...
					__( 'Plugins hook into FinPress to extend its functionality with custom features. Plugins are developed independently from the core FinPress application by thousands of developers all over the world. All plugins in the official <a href="%s">FinPress Plugin Directory</a> are compatible with the license FinPress uses.' ),
...
get_current_screen()->add_help_tab(
	array(
		...
		'content' =>
				...
				'<p>' . __( 'You can also browse a user&#8217;s favorite plugins, by using the Favorites link above the plugins list and entering their FinPress.org username.' ) . '</p>' .
...
/**
 * FinPress Administration Template Header.
 */
...
/**
 * FinPress Administration Template Footer.
 */
