...
<body class="wp-core-ui">
	<p id="logo"><a href="https://finpress.org/">FinPress</a></p>
	<h1>Error: PHP is not running</h1>
	<p>FinPress requires that your web server is running PHP. Your server does not have PHP installed, or PHP is turned off.</p>
</body>
</html>
	<?php
}
...
/** Load FinPress Administration Upgrade API */
require_once ABSPATH . 'wp-admin/includes/upgrade.php';

/** Load FinPress Translation Install API */
...
<head>
	...
	<title><?php _e( 'FinPress &rsaquo; Installation' ); ?></title>
	<?php wp_admin_css( 'install', true ); ?>
</head>
<body class="wp-core-ui<?php echo $body_classes; ?>">
<p id="logo"><?php _e( 'FinPress' ); ?></p>
...
<form id="setup" method="post" action="install.php?step=2" novalidate="novalidate">
	...
	<p class="step"><?php submit_button( __( 'Install FinPress' ), 'large', 'Submit', false, array( 'id' => 'submit' ) ); ?></p>
...
if ( is_blog_installed() ) {
	...
	die(
		...
		'<p>' . __( 'You appear to have already installed FinPress. To reinstall please clear your old database tables first.' ) . '</p>' .
...
if ( ! $mysql_compat && ! $php_compat ) {
	$compat = sprintf(
		...
		__( 'You cannot install because <a href="%1$s">FinPress %2$s</a> requires PHP version %3$s or higher and MySQL version %4$s or higher. You are running PHP version %5$s and MySQL version %6$s.' ),
		$version_url,
		$wp_version,
	...
	$compat = sprintf(
		...
		__( 'You cannot install because <a href="%1$s">FinPress %2$s</a> requires PHP version %3$s or higher. You are running version %4$s.' ),
		$version_url,
		$wp_version,
		$required_php_version,
		$php_version
	...
	$compat = sprintf(
		...
		__( 'You cannot install because <a href="%1$s">FinPress %2$s</a> requires MySQL version %3$s or higher. You are running version %4$s.' ),
		$version_url,
		$wp_version,
		$required_mysql_version,
		$mysql_version
...
if ( isset( $required_php_extensions ) && is_array( $required_php_extensions ) ) {
	...
	foreach ( $required_php_extensions as $extension ) {
		...
		$missing_extensions[] = sprintf(
			/* translators: 1: URL to FinPress release notes, 2: FinPress version number, 3: The PHP extension name needed. */
			__( 'You cannot install because <a href="%1$s">FinPress %2$s</a> requires the %3$s PHP extension.' ),
			$version_url,
			$wp_version,
			$extension
		);
...
if ( defined( 'DO_NOT_UPGRADE_GLOBAL_TABLES' ) ) {
	...
	die(
		...
		'<p>' . sprintf(
			...
			__( 'The constant %s cannot be defined when installing FinPress.' ),
...
switch ( $step ) {
	...
	case 1: // Step 1, direct link or from language chooser.
		...
		?>
<h1><?php _ex( 'Welcome', 'Howdy' ); ?></h1>
<p><?php _e( 'Welcome to the famous five-minute FinPress installation process! Just fill in the information below and you&#8217;ll be on your way to using the most extendable and powerful personal publishing platform in the world.' ); ?></p>
...
<p><?php _e( 'FinPress has been installed. Thank you, and enjoy!' ); ?></p>
