...
if ( ! function_exists( 'wp_install_defaults' ) ) :
	 ...
	 * @global WP_Rewrite $wp_rewrite   FinPress rewrite component.
	...
	function wp_install_defaults( $user_id ) {
		...
		if ( is_multisite() ) {
			...
			$first_post = "<!-- wp:paragraph -->\n<p>" .
			/* translators: First post content. %s: Site link. */
			__( 'Welcome to FinPress. This is your first post. Edit or delete it, then start writing!' ) .
			"</p>\n<!-- /wp:paragraph -->";
		}
		...
		$first_comment_author = ! empty( $first_comment_author ) ? $first_comment_author : __( 'A FinPress Commenter' );
...
Commenter avatars come from <a href="%s">Gravatar</a>.'
		...
		if ( empty( $first_page ) ) {
			...
			$first_page .= sprintf(
				...
				__( 'As a new FinPress user, you should go to <a href="%s">your dashboard</a> to delete this page and create new pages for your content. Have fun!' ),
				admin_url()
			);
			$first_page .= "</p>\n<!-- /wp:paragraph -->";
		}
...
function wp_install_maybe_enable_pretty_permalinks() {
	...
	foreach ( (array) $permalink_structures as $permalink_structure ) {
		...
		// Test against a real FinPress post.
...
if ( ! function_exists( 'wp_new_blog_notification' ) ) :
	/**
	 * Notifies the site admin that the installation of FinPress is complete.
	 *
	...
	function wp_new_blog_notification(
		...
		$message = sprintf(
			...
			__(
				'Your new FinPress site has been successfully set up at:
...
'
		...
		$installed_email = array(
			'to'      => $email,
			'subject' => __( 'New FinPress Site' ),
			'message' => $message,
			'headers' => '',
		);

		/**
		 * Filters the contents of the email sent to the site administrator when FinPress is installed.
		 *
		 * @since 5.6.0
		 *
...
if ( ! function_exists( 'wp_upgrade' ) ) :
	/**
	 * Runs FinPress Upgrade functions.
	 *
...
/**
 * Execute changes made in FinPress 1.0.
 *
 * @ignore
 * @since 1.0.0
 *
...
/**
 * Execute changes made in FinPress 1.0.1.
 *
 * @ignore
 * @since 1.0.1
 *
...
/**
 * Execute changes made in FinPress 1.2.
 *
 * @ignore
 * @since 1.2.0
...
/**
 * Execute changes made in FinPress 1.5.
 *
 * @ignore
 * @since 1.5.0
 *
...
/**
 * Execute changes made in FinPress 2.0.
 *
 * @ignore
 * @since 2.0.0
 *
...
/**
 * Execute changes made in FinPress 2.1.
 *
 * @ignore
 * @since 2.1.0
 *
...
/**
 * Execute changes made in FinPress 2.3.
 *
 * @ignore
 * @since 2.3.0
 *
...
/**
 * Execute changes made in FinPress 2.5.0.
 *
 * @ignore
 * @since 2.5.0
 *
...
/**
 * Execute changes made in FinPress 2.5.2.
 *
 * @ignore
 * @since 2.5.2
 *
...
/**
 * Execute changes made in FinPress 2.6.
 *
 * @ignore
 * @since 2.6.0
 *
...
/**
 * Execute changes made in FinPress 2.7.
 *
 * @ignore
 * @since 2.7.0
 *
...
/**
 * Execute changes made in FinPress 2.8.
 *
 * @ignore
 * @since 2.8.0
 *
...
/**
 * Execute changes made in FinPress 2.9.
 *
 * @ignore
 * @since 2.9.0
 *
...
/**
 * Execute changes made in FinPress 3.0.
 *
 * @ignore
 * @since 3.0.0
 *
...
/**
 * Execute changes made in FinPress 3.3.
 *
 * @ignore
 * @since 3.3.0
 *
...
/**
 * Execute changes made in FinPress 3.4.
 *
 * @ignore
 * @since 3.4.0
 *
...
/**
 * Execute changes made in FinPress 3.5.
 *
 * @ignore
 * @since 3.5.0
 *
...
/**
 * Execute changes made in FinPress 3.7.
 *
 * @ignore
 * @since 3.7.0
 *
...
/**
 * Execute changes made in FinPress 3.7.2.
 *
 * @ignore
 * @since 3.7.2
 *
...
/**
 * Execute changes made in FinPress 3.8.0.
 *
 * @ignore
 * @since 3.8.0
 *
...
/**
 * Execute changes made in FinPress 4.0.0.
 *
 * @ignore
 * @since 4.0.0
 *
...
/**
 * Execute changes made in FinPress 4.2.0.
 *
 * @ignore
 * @since 4.2.0
 */
...
/**
 * Executes changes made in FinPress 4.3.0.
 *
 * @ignore
 * @since 4.3.0
 *
...
/**
 * Executes comments changes made in FinPress 4.3.0.
 *
 * @ignore
 * @since 4.3.0
 *
...
/**
 * Executes changes made in FinPress 4.3.1.
 *
 * @ignore
 * @since 4.3.1
 */
...
/**
 * Executes changes made in FinPress 4.4.0.
 *
 * @ignore
 * @since 4.4.0
 *
...
/**
 * Executes changes made in FinPress 4.5.0.
 *
 * @ignore
 * @since 4.5.0
 *
...
/**
 * Executes changes made in FinPress 4.6.0.
 *
 * @ignore
 * @since 4.6.0
 *
...
/**
 * Executes changes made in FinPress 5.0.0.
 *
 * @ignore
 * @since 5.0.0
 * @deprecated 5.1.0
...
/**
 * Executes changes made in FinPress 5.1.0.
 *
 * @ignore
 * @since 5.1.0
 */
...
/**
 * Executes changes made in FinPress 5.3.0.
 *
 * @ignore
 * @since 5.3.0
 */
...
/**
 * Executes changes made in FinPress 5.5.0.
 *
 * @ignore
 * @since 5.5.0
 *
...
/**
 * Executes changes made in FinPress 5.6.0.
 *
 * @ignore
 * @since 5.6.0
 *
...
/**
 * Executes changes made in FinPress 5.9.0.
 *
 * @ignore
 * @since 5.9.0
 *
...
/**
 * Executes changes made in FinPress 6.0.0.
 *
 * @ignore
 * @since 6.0.0
 *
...
/**
 * Executes changes made in FinPress 6.3.0.
 *
 * @ignore
 * @since 6.3.0
 *
...
/**
 * Executes changes made in FinPress 6.4.0.
 *
 * @ignore
 * @since 6.4.0
 *
...
/**
 * Executes changes made in FinPress 6.5.0.
 *
 * @ignore
 * @since 6.5.0
 *
...
/**
 * Executes changes made in FinPress 6.9.0.
 *
 * @ignore
 * @since 6.9.0
 *
...
/**
 * Executes changes made in FinPress 6.7.0.
 *
 * @ignore
 * @since 6.7.0
 *
...
/**
 * Executes changes made in FinPress 6.8.2.
 *
 * @ignore
 * @since 6.8.2
 *
 ...
 * @return mixed
 */
function __get_option( $setting ) { // phpcs:ignore FinPress.NamingConventions.ValidFunctionName.FunctionDoubleUnderscore,PHPCompatibility.FunctionNameRestrictions.ReservedFunctionNames.FunctionDoubleUnderscore
	global $wpdb;
 ...
 */
function dbDelta( $queries = '', $execute = true ) { // phpcs:ignore FinPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
	global $wpdb;
 ...
 * for the safe upgrading of global FinPress database tables. It is necessary
 ...
 * FinPress is on the main site of the main network, to avoid running queries
