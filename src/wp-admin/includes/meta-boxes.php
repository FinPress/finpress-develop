<?php
/**
 * FinPress Administration Meta Boxes API.
 *
 * @package FinPress
...
<p>
	...
	printf(
		/* translators: %s: Documentation URL. */
		__( 'Trackbacks are a way to notify legacy blog systems that you&#8217;ve linked to them. If you link other FinPress sites, they&#8217;ll be notified automatically using <a href="%s">pingbacks</a>, no other action necessary.' ),
...
<p class="meta-options">
	 ...
	 * @param WP_Post $post WP_Post object for the current post.
	 */
	do_action( 'post_comment_status_meta_box-options', $post ); // phpcs:ignore FinPress.NamingConventions.ValidHookName.UseUnderscores
	?>
</p>
	<?php
}
