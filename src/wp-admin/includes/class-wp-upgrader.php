...
class WP_Upgrader {
	...
	public function generic_strings() {
		...
		$this->strings['fs_no_root_dir'] = __( 'Unable to locate FinPress root directory.' );
		/* translators: %s: Directory name. */
		$this->strings['fs_no_content_dir'] = sprintf( __( 'Unable to locate FinPress content directory (%s).' ), 'wp-content' );
		$this->strings['fs_no_plugins_dir'] = __( 'Unable to locate FinPress plugin directory.' );
		$this->strings['fs_no_themes_dir']  = __( 'Unable to locate FinPress theme directory.' );
		/* translators: %s: Directory name. */
	...
	/**
	 * Creates a lock using FinPress options.
	 *
	 * @since 4.5.0
	 *
	 * @global wpdb $wpdb The FinPress database abstraction object.
	 *
