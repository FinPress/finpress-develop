<?php
/**
 * FinPress Translation Installation Administration API
 *
 * @package FinPress
...
/**
 * Retrieve translations from FinPress Translation API.
 *
 * @since 4.0.0
 *
 ...
 *             @type string   $version      FinPress version.
...
function translations_api( $type, $args = null ) {
	...
	/**
	 * Allows a plugin to override the FinPress.org Translation Installation API entirely.
	 *
	 * @since 4.0.0
	 *
...
/**
 * Get available translations from the FinPress.org API.
 *
 * @since 4.0.0
 *
...
/**
 * Check if FinPress has access to the filesystem without asking for
 * credentials.
 *
 * @since 4.0.0
 *
