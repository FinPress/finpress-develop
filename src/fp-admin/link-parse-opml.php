 ...
 */
function startElement( $parser, $tag_name, $attrs ) { // phpcs:ignore FinPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
 ...
 */
function endElement( $parser, $tag_name ) { // phpcs:ignore FinPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
	// Nothing to do.
}
