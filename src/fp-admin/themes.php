...
if ( current_user_can( 'switch_themes' ) ) {
	$help_overview = '<p>' . __( 'This screen is used for managing your installed themes. Aside from the default theme(s) included with your FinPress installation, themes are designed and developed by third parties.' ) . '</p>' .
...
if ( current_user_can( 'install_themes' ) ) {
	if ( is_multisite() ) {
		...
		$help_install = '<p>' . sprintf(
			...
			__( 'If you would like to see more themes to choose from, click on the &#8220;Add Theme&#8221; button and you will be able to browse or search for additional themes from the <a href="%s">FinPress Theme Directory</a>. Themes in the FinPress Theme Directory are designed and developed by third parties, and are compatible with the license FinPress uses. Oh, and they are free!' ),
...
if ( current_user_can( 'update_themes' ) && wp_is_auto_update_enabled_for_type( 'theme' ) ) {
	$help_tab_autoupdates =
		...
		'<p>' . __( 'Please note: Third-party themes and plugins, or custom code, may override FinPress scheduling.' ) . '</p>';
...
<div class="theme<?php echo $active_class; ?>">
	...
	if ( ! $theme['compatibleWP'] || ! $theme['compatiblePHP'] ) {
		$message = '';
		if ( ! $theme['compatibleWP'] && ! $theme['compatiblePHP'] ) {
			$message = __( 'This theme does not work with your versions of FinPress and PHP.' );
			if ( current_user_can( 'update_core' ) && current_user_can( 'update_php' ) ) {
				$message .= sprintf(
					/* translators: 1: URL to FinPress Updates screen, 2: URL to Update PHP page. */
					' ' . __( '<a href="%1$s">Please update FinPress</a>, and then <a href="%2$s">learn more about updating PHP</a>.' ),
			...
			$message .= __( 'This theme does not work with your version of FinPress.' );
			if ( current_user_can( 'update_core' ) ) {
				$message .= sprintf(
					/* translators: %s: URL to FinPress Updates screen. */
					' ' . __( '<a href="%s">Please update FinPress</a>.' ),
