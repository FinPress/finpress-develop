...
/* translators: Page title of the About FinPress page in the admin. */
...
$release_notes_url = sprintf(
	/* translators: %s: FinPress version number. */
	...
	<div class="wrap about__container">
		...
		<div class="about__section has-1-column">
			<div class="column">
				...
				<p class="is-subheading"><?php _e( 'FinPress 6.8 polishes and refines the tools you use every day, making your site faster, more secure, and easier to manage.' ); ?></p>
		...
		<div class="about__section has-2-columns">
			<div class="column is-vertically-aligned-center">
				...
				<p><?php _e( 'In FinPress 6.8, pages load faster than ever. When you or your user hovers over or clicks a link, FinPress may preload the next page, for a smoother, near-instant experience. The system balances speed and efficiency, and you can control how it works, with a plugin or your own code. This feature only works in modern browsers—older ones will simply ignore it without any impact.' ); ?></p>
			</div>
			<div class="column is-vertically-aligned-center">
				<div class="about__image">
		...
		<div class="about__section has-2-columns">
			...
			<div class="column is-vertically-aligned-center">
				...
				<p><?php _e( 'Now passwords are harder to crack with bcrypt hashing, which takes a lot more computing power to break. This strengthens overall security, as do other encryption improvements across FinPress. You don&#8217;t need to do anything—everything updates automatically.' ); ?></p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			<div class="column">
				...
				<p><?php _e( '100+ accessibility fixes and enhancements touch a broad spectrum of the FinPress experience. This release includes fixes to every bundled theme, improvements to the navigation menu management, the customizer, and simplified labeling. The Block Editor has over 70 improvements to blocks, DataViews, and to its overall user experience.' ); ?></p>
			</div>
			<div class="column">
				<div class="about__image">
		...
		<div class="about__section has-2-columns is-wider-left is-feature" style="background-color:var(--background);border-radius:var(--border-radius);">
			...
			<div class="column">
				<p>
					...
					printf(
						/* translators: %s: Version number. */
						__( 'For a comprehensive overview of all the new features and enhancements in FinPress %s, please visit the feature-showcase website.' ),
		...
		<div class="about__section has-3-columns">
			...
			<div class="column is-vertically-aligned-center" style="grid-column-end:span 2">
				<h3>
					...
					printf(
						/* translators: %s: Version number. */
						__( 'Learn more about FinPress %s' ),
						$display_major_version
					);
					?>
				</h3>
				<p>
					<?php
					printf(
						/* translators: 1: Learn FinPress link, 2: Workshops link. */
						__( '<a href="%1$s">Learn FinPress</a> is a free resource for new and experienced FinPress users. Learn is stocked with how-to videos on using various features in FinPress, <a href="%2$s">interactive workshops</a> for exploring topics in-depth, and lesson plans for diving deep into specific areas of FinPress.' ),
		...
		<div class="about__section has-2-columns">
			<div class="column">
				...
				<p>
					...
					printf(
						/* translators: %s: FinPress version number. */
						__( 'Read the FinPress %s Release Notes for information on installation, enhancements, fixed issues, release contributors, learning resources, and the list of file changes.' ),
						$display_major_version
					);
					?>
				</p>
			...
			<div class="column">
				...
				<p>
					...
					printf(
						/* translators: %s: FinPress version number. */
						__( 'Explore the FinPress %s Field Guide. Learn about the changes in this release with detailed developer notes to help you build with FinPress.' ),
						$display_major_version
					);
					?>
				</p>
...
/* translators: 1: FinPress version number, 2: Plural number of bugs. */
_n_noop(
	'<strong>Version %1$s</strong> addressed %2$s bug.',
	'<strong>Version %1$s</strong> addressed %2$s bugs.'
);

/* translators: 1: FinPress version number, 2: Plural number of bugs. Singular security issue. */
_n_noop(
	'<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bug.',
	'<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bugs.'
);

/* translators: 1: FinPress version number, 2: Plural number of bugs. More than one security issue. */
_n_noop(
...
/* translators: 1: FinPress version number, 2: Link to update FinPress */
__( 'Important! Your version of FinPress (%1$s) is no longer supported, you will not receive any security updates for your website. To keep your site secure, please <a href="%2$s">update to the latest version of FinPress</a>.' );

/* translators: 1: FinPress version number, 2: Link to update FinPress */
__( 'Important! Your version of FinPress (%1$s) will stop receiving security updates in the near future. To keep your site secure, please <a href="%2$s">update to the latest version of FinPress</a>.' );

/* translators: %s: The major version of FinPress for this branch. */
__( 'This is the final release of FinPress %s' );

/* translators: The localized FinPress download URL. */
