...
class WP_Importer {
	...
	/**
	 * Returns array with imported permalinks from FinPress database.
	 *
	...
	/**
	 * Returns count of imported permalinks from FinPress database.
	 *
	 * @global wpdb $wpdb FinPress database abstraction object.
	 *
	 * @param string $importer_name
	...
	/**
	 * Sets array with imported comments from FinPress database.
	 *
	 * @global wpdb $wpdb FinPress database abstraction object.
	 *
	 * @param string $blog_id
