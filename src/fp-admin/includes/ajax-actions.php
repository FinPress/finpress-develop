...
/**
 * Handles dismissing a FinPress pointer via AJAX.
 *
 * @since 3.1.0
 */
...
function wp_ajax_send_link_to_editor() {
	...
	// Ping FinPress for an embed.
	$check_embed = $wp_embed->run_shortcode( '[embed]' . $src . '[/embed]' );

	// Fallback that FinPress creates when no oEmbed was found.
...
/**
 * Handles saving the user's FinPress.org username via AJAX.
 *
 * @since 4.4.0
 */
