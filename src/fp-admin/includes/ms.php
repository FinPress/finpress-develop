...
function mu_dropdown_languages( $lang_files = array(), $current = '' ) {
	...
	if ( false === $flag ) { // FinPress English.
...
function get_site_screen_help_tab_args() {
	return array(
		...
		'content' =>
			...
			'<p>' . __( '<strong>Settings</strong> &mdash; This page shows a list of all settings associated with this site. Some are created by FinPress and others are created by plugins you activate. Note that some fields are grayed out and say Serialized Data. You cannot modify these values due to the way the setting is stored in the database.' ) . '</p>',
	);
}
