...
class WP_Theme_Install_List_Table extends WP_Themes_List_Table {
	...
	/**
	 * Prints a theme from the FinPress.org API.
	 *
	 * @since 3.1.0
	 *
	 ...
	 *     An object that contains theme data returned by the FinPress.org API.
	 *
	 ...
	 *
	 * @param stdClass $theme A FinPress.org Theme API object.
	 */
