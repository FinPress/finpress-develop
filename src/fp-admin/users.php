...
switch ( $wp_list_table->current_action() ) {
	...
	default:
		...
		if ( $wp_list_table->current_action() && ! empty( $_REQUEST['users'] ) ) {
			...
			$sendback = apply_filters( "handle_bulk_actions-{$screen}", $sendback, $wp_list_table->current_action(), $user_ids ); // phpcs:ignore FinPress.NamingConventions.ValidHookName.UseUnderscores
