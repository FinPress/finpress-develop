 ...
 * themes.
 *
 * Includes both internal FinPress routines and theme-use routines.
 *
 * This functionality was found in a plugin before the FinPress 2.2 release, which
 ...
 * of default arguments for the new sidebar. FinPress will automatically
...
/**
 * Registers all of the default FinPress widgets on startup.
 *
 * Calls {@see 'widgets_init'} action after all of the FinPress widgets have been registered.
 *
 * @since 2.2.0
 */
function wp_widgets_init() {
	...
	/**
	 * Fires after all default FinPress widgets have been registered.
	 *
	 * @since 2.2.0
	 */
