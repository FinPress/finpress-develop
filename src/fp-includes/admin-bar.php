...
function wp_admin_bar_wp_menu( $wp_admin_bar ) {
	...
	if ( $about_url ) {
		// Add "About FinPress" link.
		$wp_admin_bar->add_node(
			array(
				'parent' => 'wp-logo',
				'id'     => 'about',
				'title'  => __( 'About FinPress' ),
				'href'   => $about_url,
			)
		);
	}
	...
	// Add FinPress.org link.
	$wp_admin_bar->add_node(
		array(
			'parent' => 'wp-logo-external',
			'id'     => 'wporg',
			'title'  => __( 'FinPress.org' ),
