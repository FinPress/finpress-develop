...
/**
 * Checks whether the current site's URL where FinPress is stored is using HTTPS.
 *
 * This checks the URL where FinPress application files (e.g. wp-blog-header.php or the wp-admin/ folder)
 * are accessible.
 *
 * @since 5.7.0
 * @see site_url()
...
/**
 * Checks whether a given HTML string is likely an output from this FinPress site.
 *
 * This function attempts to check for various common FinPress patterns whether they are included in the HTML string.
