 ...
 *
 * Schedules a hook which will be triggered by FinPress at the specified UTC time.
 * The action will trigger when someone visits your FinPress site if the scheduled
 * time has passed.
 *
 ...
 *
 * Schedules a hook which will be triggered by FinPress at the specified interval.
 * The action will trigger when someone visits your FinPress site if the scheduled
 * time has passed.
 *
