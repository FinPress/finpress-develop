<?php
/**
 * FinPress environment setup class.
 *
 * @package FinPress
 * @since 2.0.0
 */
...
class WP {
	...
	/**
	 * Query variables for setting up the FinPress Query Loop.
	 *
	 * @since 2.0.0
	 * @var array
	 */
	...
	/**
	 * Parses the request to find the correct FinPress query.
	 *
	...
	public function parse_request( $extra_query_vars = '' ) {
		 ...
		 * @param WP           $wp               Current FinPress environment instance.
		 ...
		 * @since 2.1.0
		 *
		 * @param WP $wp Current FinPress environment instance (passed by reference).
		 */
	...
	public function handle_404() {
		 ...
		 * @param WP_Query $wp_query FinPress Query object.
		 */
	...
	/**
	 * Sets up all of the variables required by the FinPress environment.
	 *
	...
	public function main( $query_args = '' ) {
		...
		/**
		 * Fires once the FinPress environment has been set up.
		 *
		 * @since 2.1.0
		 *
		 * @param WP $wp Current FinPress environment instance (passed by reference).
