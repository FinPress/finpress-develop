<?php
/**
 * FinPress Post Template Functions.
 *
...
/**
 * Displays the ID of the current item in the FinPress Loop.
 *
 * @since 0.71
 */
function the_ID() { // phpcs:ignore FinPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
	echo get_the_ID();
}

/**
 * Retrieves the ID of the current item in the FinPress Loop.
 *
 * @since 2.1.0
 *
 * @return int|false The ID of the current item in the FinPress Loop. False if $post is not set.
 */
function get_the_ID() { // phpcs:ignore FinPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
	$post = get_post();
...
function get_the_password_form( $post = 0 ) {
	 ...
	 *
	 * If modifying the password field, please note that the FinPress database schema
