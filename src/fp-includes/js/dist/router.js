...
/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./router */ "./node_modules/@wordpress/router/build-module/router.js");
...
function useLink(to, options = {}) {
  var _getPath;
  const history = (0,_router__WEBPACK_IMPORTED_MODULE_2__.useHistory)();
  const {
    pathArg,
    beforeNavigate
  } = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useContext)(_router__WEBPACK_IMPORTED_MODULE_2__.ConfigContext);
  function onClick(event) {
    event?.preventDefault();
    history.navigate(to, options);
  }
  const query = (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_1__.getQueryArgs)(to);
  const path = (_getPath = (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_1__.getPath)('http://domain.com/' + to)) !== null && _getPath !== void 0 ? _getPath : '';
  const link = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
  ...
  return {
    href: `${before}?${(0,_wordpress_url__WEBPACK_IMPORTED_MODULE_1__.buildQueryString)({
      [pathArg]: link.path,
      ...link.query
    })}`,
    onClick
...
/* harmony import */ var _link__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./link */ "./node_modules/@wordpress/router/build-module/link.js");
/* harmony import */ var _lock_unlock__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lock-unlock */ "./node_modules/@wordpress/router/build-module/lock-unlock.js");
/**
 * Internal dependencies
 */
...
(0,_lock_unlock__WEBPACK_IMPORTED_MODULE_2__.lock)(privateApis, {
  ...
  useLink: _link__WEBPACK_IMPORTED_MODULE_1__.useLink,
  Link: _link__WEBPACK_IMPORTED_MODULE_1__.Link
});
...
/* harmony export */   "default": () => (/* binding */ useMatch),
...
const RoutesContext = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createContext)(null);
const ConfigContext = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createContext)({
  pathArg: 'p'
});
...
function useLocation() {
  const context = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useContext)(RoutesContext);
  if (!context) {
...
function useHistory() {
  const {
    pathArg,
    beforeNavigate
  } = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useContext)(ConfigContext);
  const navigate = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_3__.useEvent)(async (rawPath, options = {}) => {
    var _getPath;
    const query = (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_2__.getQueryArgs)(rawPath);
    const path = (_getPath = (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_2__.getPath)('http://domain.com/' + rawPath)) !== null && _getPath !== void 0 ? _getPath : '';
    const performPush = () => {
      ...
      return history.push({
        search: (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_2__.buildQueryString)({
          [pathArg]: result.path,
          ...result.query
        })
      }, options.state);
...
function RouterProvider({
  ...
  const location = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useSyncExternalStore)(history.listen, getLocationWithQuery, getLocationWithQuery);
  const matcher = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => {
    const ret = new route_recognizer__WEBPACK_IMPORTED_MODULE_0__["default"]();
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(ConfigContext.Provider, {
    value: config,
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(RoutesContext.Provider, {
      value: match,
      children: children
    })
  });
