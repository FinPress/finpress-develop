...
const withPluginContext = mapContextToProps => (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.createHigherOrderComponent)(OriginalComponent => {
  _wordpress_deprecated__WEBPACK_IMPORTED_MODULE_2___default()('wp.plugins.withPluginContext', {
    since: '6.8.0',
    alternative: 'wp.plugins.usePluginContext'
  });
  return props => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(Context.Consumer, {
    children: context => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(OriginalComponent, {
      ...props,
