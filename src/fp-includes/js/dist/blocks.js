...
function createBlock(name, attributes = {}, innerBlocks = []) {
  if (!(0,_utils__WEBPACK_IMPORTED_MODULE_1__.isBlockRegistered)(name)) {
...
function __experimentalCloneSanitizedBlock(block, mergeAttributes = {}, newInnerBlocks) {
  ...
  const clientId = (0,uuid__WEBPACK_IMPORTED_MODULE_2__["default"])();
  const sanitizedAttributes = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.__experimentalSanitizeBlockAttributes)(name, {
    ...block.attributes,
    ...mergeAttributes
  });
  return {
...
(0,_lock_unlock__WEBPACK_IMPORTED_MODULE_15__.lock)(privateApis, {
  isContentBlock: _utils__WEBPACK_IMPORTED_MODULE_10__.isContentBlock
});
...
/* harmony import */ var _fix_aria_label__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fix-aria-label */ "./node_modules/@wordpress/blocks/build-module/api/parser/fix-aria-label.js");
/**
 * Internal dependencies
 */
...
function applyBuiltInValidationFixes(block, blockType) {
  ...
  updatedBlockAttributes = (0,_fix_custom_classname__WEBPACK_IMPORTED_MODULE_0__.fixCustomClassname)(attributes, blockType, originalContent);
  // Fix block invalidation for ariaLabel attribute.
  updatedBlockAttributes = (0,_fix_aria_label__WEBPACK_IMPORTED_MODULE_1__.fixAriaLabel)(updatedBlockAttributes, blockType, originalContent);
  return {
    ...block,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   fixAriaLabel: () => (/* binding */ fixAriaLabel),
/* harmony export */   getHTMLRootElementAriaLabel: () => (/* binding */ getHTMLRootElementAriaLabel)
/* harmony export */ });
...
function getHTMLRootElementAriaLabel(innerHTML) {
  const parsed = (0,_get_block_attributes__WEBPACK_IMPORTED_MODULE_0__.parseWithAttributeSchema)(`<div data-aria-label>${innerHTML}</div>`, ARIA_LABEL_ATTR_SCHEMA);
  return parsed;
}
...
function fixAriaLabel(blockAttributes, blockType, innerHTML) {
  if (!(0,_registration__WEBPACK_IMPORTED_MODULE_1__.hasBlockSupport)(blockType, 'ariaLabel', false)) {
...
const registerBlockBindingsSource = source => {
  ...
  if (label && existingSource?.label && label !== existingSource?.label) {
     true ? _wordpress_warning__WEBPACK_IMPORTED_MODULE_2___default()('Block bindings "' + name + '" source label was overridden.') : 0;
  }
...
function synchronizeBlocksWithTemplate(blocks = [], template) {
  ...
  return template.map(([name, attributes, innerBlocksTemplate], index) => {
    ...
    const [blockName, blockAttributes] = (0,_parser_convert_legacy_block__WEBPACK_IMPORTED_MODULE_2__.convertLegacyBlockNameAndAttributes)(name, normalizedAttributes);
...
/* harmony export */   isBlockRegistered: () => (/* binding */ isBlockRegistered),
/* harmony export */   isContentBlock: () => (/* binding */ isContentBlock),
...
function isBlockRegistered(name) {
  return (0,_registration__WEBPACK_IMPORTED_MODULE_8__.getBlockType)(name) !== undefined;
}
...
const processBlockType = (name, blockSettings) => ({
  ...
  if (typeof settings?.parent === 'string' || settings?.parent instanceof String) {
    settings.parent = [settings.parent];
     true ? _wordpress_warning__WEBPACK_IMPORTED_MODULE_4___default()('Parent must be undefined or an array of strings (block types), but it is a string.') : 0;
  ...
  if (!Array.isArray(settings?.parent) && settings?.parent !== undefined) {
     true ? _wordpress_warning__WEBPACK_IMPORTED_MODULE_4___default()('Parent must be undefined or an array of block types, but it is ', settings.parent) : 0;
    return;
  }
  if (1 === settings?.parent?.length && name === settings.parent[0]) {
     true ? _wordpress_warning__WEBPACK_IMPORTED_MODULE_4___default()('Block "' + name + '" cannot be a parent of itself. Please remove the block name from the parent list.') : 0;
    return;
  }
  return settings;
};
