...
const getDownloadableBlocks = filterValue => async ({
  ...
  try {
    ...
    dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_1__.receiveDownloadableBlocks)([], filterValue));
  }
};
...
}, state => [getInstalledBlockTypes(state), select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.store).getClientIdsWithDescendants()]));
