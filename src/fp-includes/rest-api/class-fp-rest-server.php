...
/**
 * Core class used to implement the FinPress REST API server.
 *
 * @since 4.4.0
 */
...
class WP_REST_Server {
	...
	/**
	 * Exposes the site logo through the FinPress REST API.
	 *
	...
	/**
	 * Exposes the site icon through the FinPress REST API.
	 *
	 * This is used for fetching this information when user has no rights
	 * to update settings.
	 *
	...
	/**
	 * Exposes an image through the FinPress REST API.
	 * This is used for fetching this information when user has no rights
	 * to update settings.
	 *
	 * @since 5.9.0
