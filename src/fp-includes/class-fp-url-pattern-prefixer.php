...
class WP_URL_Pattern_Prefixer {
	 ...
	 *
	 * This ensures that these path patterns work correctly on FinPress subdirectory sites, for example in a multisite
	 * network, or when FinPress itself is installed in a subdirectory of the hostname.
	 *
