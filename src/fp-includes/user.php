...
/**
 * Authenticates the user using the FinPress auth cookie.
 *
 * @since 2.8.0
 *
 * @global string $auth_secure_cookie
 ...
 * it will prepend the FinPress table prefix to the option name.
 *
 ...
 *
 * Default contact methods were removed for new installations in FinPress 3.6
 * and completely removed from the codebase in FinPress 6.9.
 *
...
function wp_register_user_personal_data_exporter( $exporters ) {
	$exporters['finpress-user'] = array(
		'exporter_friendly_name' => __( 'FinPress User' ),
...
function wp_user_personal_data_exporter( $email_address ) {
	...
	if ( isset( $user_meta['community-events-location'] ) ) {
		...
		$data_to_export[] = array(
			...
			'group_description' => __( 'User&#8217;s location data used for the Community Events in the FinPress Events and News dashboard widget.' ),
