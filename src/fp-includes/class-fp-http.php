...
class WP_Http {
	 ...
	 *                                             Default 'FinPress/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ).
	...
	public function request( $url, $args = array() ) {
		$defaults = array(
			 ...
			 * @since 5.1.0 The `$url` parameter was added.
			 *
			 * @param string $user_agent FinPress user agent string.
			 * @param string $url        The request URL.
			 */
			'user-agent'          => apply_filters( 'http_headers_useragent', 'FinPress/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ), $url ),
			/**
	 ...
	 * }
	 */
	public static function processResponse( $response ) { // phpcs:ignore FinPress.NamingConventions.ValidFunctionName.MethodNameInvalid
		$response = explode( "\r\n\r\n", $response, 2 );
	 ...
	 * }
	 */
	public static function processHeaders( $headers, $url = '' ) { // phpcs:ignore FinPress.NamingConventions.ValidFunctionName.MethodNameInvalid
	 ...
	 */
	public static function buildCookieHeader( &$r ) { // phpcs:ignore FinPress.NamingConventions.ValidFunctionName.MethodNameInvalid
		if ( ! empty( $r['cookies'] ) ) {
	 ...
	 */
	public static function chunkTransferDecode( $body ) { // phpcs:ignore FinPress.NamingConventions.ValidFunctionName.MethodNameInvalid
	 ...
	 * @link https://core.trac.finpress.org/ticket/14636 Allow wildcard domains in WP_ACCESSIBLE_HOSTS
	 *
