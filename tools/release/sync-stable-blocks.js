 ...
 * Constants
 */
const BLOCK_LIBRARY_SRC = 'node_modules/@finpress/block-library/src/';
 ...
 *
 * Refreshes the PHP files referring to stable @finpress/block-library blocks.
 */
function main() {
 ...
 * of the @finpress/block-library package/
 *
